...
def performance_scores(request):
    ...
    context = {
        'real_compression_test': results['real_compression_test'],
        'real_encryption_test': results['real_encryption_test'],
        'individual_compression': results['individual_compression'],
        'individual_encryption': results['individual_encryption'],
    }
    
    return render(request, 'centralapp/performance_scores.html', context)
